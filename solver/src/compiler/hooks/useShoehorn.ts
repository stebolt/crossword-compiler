...
function loadShoehorn(initial?: string[]): string[] {
...
export function useShoehorn(initialShoehorn?: string[]) {
  const [shoehorn, setShoehornRaw] = useState<string[]>(() => loadShoehorn(initialShoehorn));
